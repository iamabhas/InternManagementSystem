...
const BatchDetails=({selectComponentState})=>{
    ...
    return <>
        <main>
            ...
            <Typography variant="h5" sx={{m: 3}} textAlign={"center"}>Batch Members for : {batchName}</Typography>
            <Divider />
<Box className="flex-component-space" sx={{m:2}}>
    <TableContainer component={Paper} sx={{m:1}}>
        <Typography textAlign="center" variant="h5">Interns</Typography>
        <Table>
            ...
            <TableBody>
                {batchInterns.map((interns, index) => {
                    return <TableCell key={index} align="center">{interns.fullname}</TableCell>
                })}
            </TableBody>
    ...
    <TableContainer component={Paper} sx={{m:1}}>
        <Typography textAlign="center" variant="h5">Mentors</Typography>
        <Table>
