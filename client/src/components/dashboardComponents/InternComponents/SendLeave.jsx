...
const SendLeave = () => {
    ...
    const onSubmit = async (data) => {
        console.log({...data, leaveFromDate: dateInputs.leaveFromDate, leaveToDate: dateInputs.leaveToDate});
        handleClose();
    };
                        ...
                        <Grid container spacing={2} sx={{p: 2}}>
                            ...
                            <Grid item xs={12} sm={12}>
                                ...
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    ...
                                    <DatePicker label="Start of Leave" sx={{m: 1}} fullWidth
                                                value={dateInputs.leaveFromDate}
                                                onChange={(date) => handleDateChange("leaveFromDate", date)}/>

                                    <DatePicker label="End of Leave" sx={{m: 1}} fullWidth
