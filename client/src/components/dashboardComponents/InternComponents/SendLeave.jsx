    ...
    return (
        <div>
            ...
            <Dialog open={applicationDialog} onClose={handleApplicationClose}>
                ...
                <Button color="error" onClick={handleApplicationClose}>close</Button>
            </Dialog>
            <Box sx={{mt: 2}}>
                        ...
                        <TableBody>
                            {[...leavesData].reverse().map((leave) => (
                                <TableRow key={leave.id}>
                                    ...
                                    <TableCell>{formatDate(leave.leaveFromDate)} -- {formatDate(leave.leaveToDate)}</TableCell>
                                    <TableCell>
                                        {leave.approveStatus ? GetStatusChip("approved") : GetStatusChip("pending")}
                                    </TableCell>
                                    <TableCell>
                                        <Button onClick={() => {
