                    ...
                    <TableContainer>
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell>
                                        <Chip icon={<FaSchool/>} label="University" sx={{fontSize: 20}}/>
                                    </TableCell>
                                    <TableCell>
                                        <Chip icon={<FaUserGraduate/>} label="Graduation" sx={{fontSize: 20}}/>
                                    </TableCell>
                                    <TableCell>
                                        <Chip icon={<HiMiniWrenchScrewdriver/>} label="Skills" sx={{fontSize: 20}}/>
                                    </TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                <TableRow>
                                    <TableCell>{qualificationsData.universityName}</TableCell>
                                    <TableCell>{returnMonthName(qualificationsData.graduationMonth)} of {qualificationsData.graduationYear}</TableCell>
                                    <TableCell>{qualificationsData.skills}</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </TableContainer>
